<div class="card indigo">
    <div class="card-content">
      <h4 class="white-text">Administrativos</h4>
    </div>
    <div class="card-tabs">
      <ul class="tabs tabs-fixed-width tabs-transparent" tabs reload="allTabContentLoaded">
        <li class="tab"><a class="active" href="#tab_activos">Activos</a></li>
        <li class="tab"><a href="#tab_inactivos" ng-click="listar_admin_inactivos()">Inactivos</a></li>
      </ul>
    </div>
    <div class="card-content blue lighten-5">
      <div id="tab_activos">
        <div class="card-panel">
          <div class="row">
            <div class="col l8">
              <a class="btn-floating btn-large waves-effect waves-light blue modalopen" data-namemodal="addadmin"><i class="material-icons left">add</i></a>
            </div>
            <div class="col l4">
          ...
          <table class="responsive-table highlight">
            ...
            <tbody>
            <tr ng-repeat="a in lista_activos | filter : buscar">
				        <td>
	                <span class="avatar-status">
	                  <img src="<?=base_url()?>{{a.foto_perfil}}" alt="avatar">
	                </span>
	              </td>
              	<td>{{a.nombres}}</td>
              	<td>{{a.a_paterno}}</td>
              	...
              	<td>{{a.sexo}}</td>
              	<td>{{a.cargo}}</td>
              	<td><a class="btn-floating waves-effect waves-light orange" ng-click="ver_registro_admin($index)"><i class="material-icons">add</i></a>&nbsp;&nbsp;<a class="btn-floating waves-effect waves-light green" ng-click="form_modificar_registro_admin($index)"><i class="material-icons">edit</i></a>&nbsp;&nbsp;<a class="btn-floating waves-effect waves-light red" ng-click="desactivar_registro_admin(a.id)"><i class="material-icons">delete</i></a></td>
            </tr>
            </tbody>
          </table>
        </div>        
      ...
      <div id="tab_inactivos">
        <ul class="collection">
			<li class="collection-item avatar" ng-repeat="a2 in lista_inactivos">
	            <img src="<?=base_url()?>{{a2.foto_perfil}}" alt="" class="circle">
	            <span class="title">{{a2.nombres}} {{a2.a_paterno}} {{a2.a_materno}}</span><br>
	            <a class="secondary-content btn-floating waves-effect waves-light blue" ng-click="activar_registro_admin(a2.id)"><i class="material-icons">restore</i></a>
	            <span class="task-cat red" style="margin: 0;"> Cargo: {{a2.especialidad}}</span>
	        </li>
        </ul>
      </div>
    </div>
</div>
<div id="addadmin" class="modal full-modal modal-md">
  <div class="modal-content">
    <div class="col s12">
      <div class="card" style="margin: 0;">
        <div class="card-content">
          <form id="form_add_admin" ng-submit="agregar_registro_admin($event)">
            <ul class="stepper horizontal" id="horizontal">
              ...
              <li class="step">
                <div data-step-label="Cargo" class="step-title waves-effect waves-dark">Paso 2</div>
                <div class="step-content">
                  <div class="row">
                    <div class="input-field col s12">
                      <i class="material-icons prefix">work</i>
                      <input id="in_cargo" name="cargo" type="text" class="validate" required>
                      <label for="in_cargo">Cargo</label>
                    </div>
                  </div>
                  <div class="step-actions">
                    <button class="waves-effect waves-dark btn blue next-step" type="button">Continuar</button>
...
<div id="editadmin" class="modal full-modal modal-md">
  <div class="modal-content">
    <div class="col s12">
      <div class="card" style="margin: 0;">
        <div class="card-content">
          <form id="form_edit_admin" ng-submit="modificar_registro_admin($event)">
            <ul class="stepper horizontal" id="horizontal">
              <li class="step active">
                <div data-step-label="Persona" class="step-title waves-effect waves-dark">Paso 1</div>
                <div class="step-content">
              ...
              <li class="step">
                ...
                <div class="step-content">
                  <div class="row">
                    <div class="input-field col s12">
                      <i class="material-icons prefix">work</i>
                      <input id="in_especialidad2" ng-model="form.cargo" name="cargo" type="text" class="validate" required>
                      <label for="in_especialidad2">Cargo</label>
                    </div>
                  </div>
                  <div class="step-actions">
                    <button class="waves-effect waves-dark btn blue next-step" type="button">Continuar</button>
...
<div id="veradmin" class="modal bottom-sheet">
    <div class="modal-content">
      <div class="row">
        <div class="col s12 m4 l4">
          <div id="profile-card" class="card">
            ...
            <div class="card-content">
              ...
              <a class="btn-floating btn-move-up waves-effect waves-light red accent-2 z-depth-4 right" ng-click="form_modificar_registro_admin2()">
                <i class="material-icons">edit</i>
              </a>
              <span class="card-title grey-text text-darken-4">{{info_pro.nombres}} {{info_pro.a_paterno}}</span>
              <p>{{info_pro.especialidad}}</p>
            </div>
          </div>   
        </div>
